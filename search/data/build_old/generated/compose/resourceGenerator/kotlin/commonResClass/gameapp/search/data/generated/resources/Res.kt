...
package gameapp.search.`data`.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/gameapp.search.data.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/gameapp.search.data.generated.resources/" + path)
