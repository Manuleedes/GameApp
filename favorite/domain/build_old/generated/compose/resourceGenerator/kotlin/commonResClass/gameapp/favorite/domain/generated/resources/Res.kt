...
package gameapp.favorite.domain.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/gameapp.favorite.domain.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/gameapp.favorite.domain.generated.resources/" + path)
